...
//		SharedDriver.pageContainer.materialPage.getCurrDate();
		SharedDriver.pageContainer.materialPage.globalSearch(dataMap.get("GlobalId"));
	...
	public void Material_Create_Fill_In_Data_Change(Map<String,String> dataMap) throws InterruptedException, FileNotFoundException, IOException 
	{
		...
		SharedDriver.pageContainer.materialPage.unitOfWeightSelectionTest("G");
		SharedDriver.pageContainer.materialPage.baseUOMSelectionTest("G");
